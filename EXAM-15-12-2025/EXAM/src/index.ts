...
const welcomeSnack = new WelcomeSnack(1, 'Garlic Bread', 50, MenuItemType.WelcomeSnack, true, 5);
const mainCourse = new MainCourse(2, 'Steak', 300, MenuItemType.MainCourse, 20, 25);
const dessert = new Dessert(3, 'Chocolate Cake', 150, MenuItemType.Dessert, true, 10);
